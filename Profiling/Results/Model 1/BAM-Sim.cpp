...
cout << endl;
  ...
  styr_fleet2_L.allocate("styr_fleet2_L");
  endyr_fleet2_L.allocate("endyr_fleet2_L");
  obs_fleet2_L.allocate(styr_fleet2_L,endyr_fleet2_L,"obs_fleet2_L");
  fleet2_L_cv.allocate(styr_fleet2_L,endyr_fleet2_L,"fleet2_L_cv");
  nyr_fleet2_agec.allocate("nyr_fleet2_agec");
  yrs_fleet2_agec.allocate(1,nyr_fleet2_agec,"yrs_fleet2_agec");
  nsamp_fleet2_agec.allocate(1,nyr_fleet2_agec,"nsamp_fleet2_agec");
  nfish_fleet2_agec.allocate(1,nyr_fleet2_agec,"nfish_fleet2_agec");
  obs_fleet2_agec.allocate(1,nyr_fleet2_agec,1,nages_agec,"obs_fleet2_agec");
  styr_fleet3_D.allocate("styr_fleet3_D");
  endyr_fleet3_D.allocate("endyr_fleet3_D");
  obs_fleet3_D.allocate(styr_fleet3_D,endyr_fleet3_D,"obs_fleet3_D");
  fleet3_D_cv.allocate(styr_fleet3_D,endyr_fleet3_D,"fleet3_D_cv");
  nyr_fleet3_lenc.allocate("nyr_fleet3_lenc");
  yrs_fleet3_lenc.allocate(1,nyr_fleet3_lenc,"yrs_fleet3_lenc");
  nsamp_fleet3_lenc.allocate(1,nyr_fleet3_lenc,"nsamp_fleet3_lenc");
  nfish_fleet3_lenc.allocate(1,nyr_fleet3_lenc,"nfish_fleet3_lenc");
  obs_fleet3_lenc.allocate(1,nyr_fleet3_lenc,1,nlenbins,"obs_fleet3_lenc");
  f_ckmr.allocate("f_ckmr");
  e_ckmr.allocate("e_ckmr");
  c1.allocate(f_ckmr,e_ckmr,"c1");
  c2.allocate(f_ckmr,e_ckmr,"c2");
  s1.allocate(f_ckmr,e_ckmr,"s1");
  HSPs.allocate(f_ckmr,e_ckmr,"HSPs");
  POPs.allocate(f_ckmr,e_ckmr,"POPs");
  Not.allocate(f_ckmr,e_ckmr,"Not");
  set_Linf.allocate(1,7,"set_Linf");
  set_K.allocate(1,7,"set_K");
  set_t0.allocate(1,7,"set_t0");
  set_len_cv.allocate(1,7,"set_len_cv");
  set_M_logit.allocate(1,7,"set_M_logit");
  set_M_b.allocate(1,7,"set_M_b");
  ...
  set_log_dm_fleet2_ac.allocate(1,7,"set_log_dm_fleet2_ac");
  set_log_dm_fleet3_lc.allocate(1,7,"set_log_dm_fleet3_lc");
  ...
  set_selpar_A50_fleet2_B1.allocate(1,7,"set_selpar_A50_fleet2_B1");
  set_selpar_slope_fleet2_B1.allocate(1,7,"set_selpar_slope_fleet2_B1");
  set_selpar_A50_asc_fleet3_B1.allocate(1,7,"set_selpar_A50_asc_fleet3_B1");
  set_selpar_slope_asc_fleet3_B1.allocate(1,7,"set_selpar_slope_asc_fleet3_B1");
  set_selpar_A50_dsc_fleet3_B1.allocate(1,7,"set_selpar_A50_dsc_fleet3_B1");
  set_selpar_slope_dsc_fleet3_B1.allocate(1,7,"set_selpar_slope_dsc_fleet3_B1");
  ...
  set_log_avg_F_fleet2.allocate(1,7,"set_log_avg_F_fleet2");
  set_log_avg_F_fleet3.allocate(1,7,"set_log_avg_F_fleet3");
  set_log_F_dev_fleet1.allocate(1,3,"set_log_F_dev_fleet1");
  set_log_F_dev_fleet2.allocate(1,3,"set_log_F_dev_fleet2");
  set_log_F_dev_fleet3.allocate(1,3,"set_log_F_dev_fleet3");
  ...
  set_log_F_dev_fleet2_vals.allocate(styr_fleet2_L,endyr_fleet2_L,"set_log_F_dev_fleet2_vals");
  set_log_F_dev_fleet3_vals.allocate(styr_fleet3_D,endyr_fleet3_D,"set_log_F_dev_fleet3_vals");
  ...
  set_w_ac_fleet2.allocate("set_w_ac_fleet2");
  set_w_lc_fleet3.allocate("set_w_lc_fleet3");
  ...
  M_len.allocate(1,nages,"M_len");
  M_lor_scale.allocate("M_lor_scale");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  const double M_b_LO=set_M_b(2); const double M_b_HI=set_M_b(3); const double M_b_PH=set_M_b(4);
  ...
  wgt_lb.allocate(1,nages,"wgt_lb");
    ...
    wgt_lb.initialize();
  #endif
  M_logit.allocate(M_logit_LO,M_logit_HI,M_logit_PH,"M_logit");
  M_b.allocate(M_b_LO,M_b_HI,M_b_PH,"M_b");
  M_scale.allocate("M_scale");
  #ifndef NO_AD_INITIALIZE
  M_scale.initialize();
  #endif
  M_lorenzen.allocate(1,nages,"M_lorenzen");
  #ifndef NO_AD_INITIALIZE
    M_lorenzen.initialize();
  #endif
  M_unscaled.allocate(1,nages,"M_unscaled");
  #ifndef NO_AD_INITIALIZE
    M_unscaled.initialize();
  #endif
  M_logit_out.allocate(1,8,"M_logit_out");
  #ifndef NO_AD_INITIALIZE
    M_logit_out.initialize();
  #endif
  M_b_out.allocate(1,8,"M_b_out");
  #ifndef NO_AD_INITIALIZE
    M_b_out.initialize();
  #endif
  ...
  #endif
  lenprob_fleet3.allocate(1,nages,1,nlenbins,"lenprob_fleet3");
  #ifndef NO_AD_INITIALIZE
    lenprob_fleet3.initialize();
  #endif
  ...
  #endif
  pred_fleet2_agec.allocate(1,nyr_fleet2_agec,1,nages_agec,"pred_fleet2_agec");
  #ifndef NO_AD_INITIALIZE
    pred_fleet2_agec.initialize();
  #endif
  pred_fleet2_agec_allages.allocate(1,nyr_fleet2_agec,1,nages,"pred_fleet2_agec_allages");
  #ifndef NO_AD_INITIALIZE
    pred_fleet2_agec_allages.initialize();
  #endif
  ErrorFree_fleet2_agec.allocate(1,nyr_fleet2_agec,1,nages,"ErrorFree_fleet2_agec");
  #ifndef NO_AD_INITIALIZE
    ErrorFree_fleet2_agec.initialize();
  #endif
  pred_fleet3_lenc.allocate(1,nyr_fleet3_lenc,1,nlenbins,"pred_fleet3_lenc");
  #ifndef NO_AD_INITIALIZE
    pred_fleet3_lenc.initialize();
  #endif
  ...
  #endif
  nsamp_fleet2_agec_allyr.allocate(styr,endyr,"nsamp_fleet2_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nsamp_fleet2_agec_allyr.initialize();
  #endif
  nsamp_fleet3_lenc_allyr.allocate(styr,endyr,"nsamp_fleet3_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    nsamp_fleet3_lenc_allyr.initialize();
  #endif
  ...
  #endif
  nfish_fleet2_agec_allyr.allocate(styr,endyr,"nfish_fleet2_agec_allyr");
  #ifndef NO_AD_INITIALIZE
    nfish_fleet2_agec_allyr.initialize();
  #endif
  nfish_fleet3_lenc_allyr.allocate(styr,endyr,"nfish_fleet3_lenc_allyr");
  #ifndef NO_AD_INITIALIZE
    nfish_fleet3_lenc_allyr.initialize();
  #endif
  ...
  #endif
  neff_fleet2_agec_allyr_out.allocate(styr,endyr,"neff_fleet2_agec_allyr_out");
  #ifndef NO_AD_INITIALIZE
    neff_fleet2_agec_allyr_out.initialize();
  #endif
  neff_fleet3_lenc_allyr_out.allocate(styr,endyr,"neff_fleet3_lenc_allyr_out");
  #ifndef NO_AD_INITIALIZE
    neff_fleet3_lenc_allyr_out.initialize();
  #endif
  ...
  reprod.allocate(1,nages,"reprod");
    ...
    reprod.initialize();
  #endif
  ckmr_fec.allocate(1,nages,"ckmr_fec");
  #ifndef NO_AD_INITIALIZE
    ckmr_fec.initialize();
  #endif
  ...
  log_dm_fleet2_ac.allocate(log_dm_fleet2_ac_LO,log_dm_fleet2_ac_HI,log_dm_fleet2_ac_PH,"log_dm_fleet2_ac");
  log_dm_fleet3_lc.allocate(log_dm_fleet3_lc_LO,log_dm_fleet3_lc_HI,log_dm_fleet3_lc_PH,"log_dm_fleet3_lc");
  ...
  #endif
  log_dm_fleet2_ac_out.allocate(1,8,"log_dm_fleet2_ac_out");
  #ifndef NO_AD_INITIALIZE
    log_dm_fleet2_ac_out.initialize();
  #endif
  log_dm_fleet3_lc_out.allocate(1,8,"log_dm_fleet3_lc_out");
  #ifndef NO_AD_INITIALIZE
    log_dm_fleet3_lc_out.initialize();
  #endif
  ...
  #endif
  sel_fleet2.allocate(styr,endyr,1,nages,"sel_fleet2");
  #ifndef NO_AD_INITIALIZE
  ...
  #endif
  selvec_fleet2_B1.allocate(1,nages,"selvec_fleet2_B1");
  #ifndef NO_AD_INITIALIZE
    selvec_fleet2_B1.initialize();
  #endif
  ...
  selpar_A50_fleet2_B1.allocate(selpar_A50_fleet2_B1_LO,selpar_A50_fleet2_B1_HI,selpar_A50_fleet2_B1_PH,"selpar_A50_fleet2_B1");
  selpar_slope_fleet2_B1.allocate(selpar_slope_fleet2_B1_LO,selpar_slope_fleet2_B1_HI,selpar_slope_fleet2_B1_PH,"selpar_slope_fleet2_B1");
  sel_fleet3.allocate(styr,endyr,1,nages,"sel_fleet3");
  #ifndef NO_AD_INITIALIZE
    sel_fleet3.initialize();
  #endif
  selvec_fleet3_B1.allocate(1,nages,"selvec_fleet3_B1");
  #ifndef NO_AD_INITIALIZE
    selvec_fleet3_B1.initialize();
  #endif
  selpar_A50_asc_fleet3_B1.allocate(selpar_A50_asc_fleet3_B1_LO,selpar_A50_asc_fleet3_B1_HI,selpar_A50_asc_fleet3_B1_PH,"selpar_A50_asc_fleet3_B1");
  selpar_slope_asc_fleet3_B1.allocate(selpar_slope_asc_fleet3_B1_LO,selpar_slope_asc_fleet3_B1_HI,selpar_slope_asc_fleet3_B1_PH,"selpar_slope_asc_fleet3_B1");
  selpar_A50_dsc_fleet3_B1.allocate(selpar_A50_dsc_fleet3_B1_LO,selpar_A50_dsc_fleet3_B1_HI,selpar_A50_dsc_fleet3_B1_PH,"selpar_A50_dsc_fleet3_B1");
  selpar_slope_dsc_fleet3_B1.allocate(selpar_slope_dsc_fleet3_B1_LO,selpar_slope_dsc_fleet3_B1_HI,selpar_slope_dsc_fleet3_B1_PH,"selpar_slope_dsc_fleet3_B1");
  ...
  #endif
  selpar_A50_fleet2_B1_out.allocate(1,8,"selpar_A50_fleet2_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_fleet2_B1_out.initialize();
  #endif
  selpar_slope_fleet2_B1_out.allocate(1,8,"selpar_slope_fleet2_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_fleet2_B1_out.initialize();
  #endif
  selpar_A50_asc_fleet3_B1_out.allocate(1,8,"selpar_A50_asc_fleet3_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_asc_fleet3_B1_out.initialize();
  #endif
  selpar_slope_asc_fleet3_B1_out.allocate(1,8,"selpar_slope_asc_fleet3_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_asc_fleet3_B1_out.initialize();
  #endif
  selpar_A50_dsc_fleet3_B1_out.allocate(1,8,"selpar_A50_dsc_fleet3_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_A50_dsc_fleet3_B1_out.initialize();
  #endif
  selpar_slope_dsc_fleet3_B1_out.allocate(1,8,"selpar_slope_dsc_fleet3_B1_out");
  #ifndef NO_AD_INITIALIZE
    selpar_slope_dsc_fleet3_B1_out.initialize();
  #endif
  ...
  #endif
  log_F1_dev_output.allocate(styr,endyr,"log_F1_dev_output");
  #ifndef NO_AD_INITIALIZE
    log_F1_dev_output.initialize();
  #endif
  log_F2_dev_output.allocate(styr,endyr,"log_F2_dev_output");
  #ifndef NO_AD_INITIALIZE
    log_F2_dev_output.initialize();
  #endif
  log_F3_dev_output.allocate(styr,endyr,"log_F3_dev_output");
  #ifndef NO_AD_INITIALIZE
  ...
  #endif
  L_fleet2_num.allocate(styr,endyr,1,nages,"L_fleet2_num");
  #ifndef NO_AD_INITIALIZE
    L_fleet2_num.initialize();
  #endif
  L_fleet2_mt.allocate(styr,endyr,1,nages,"L_fleet2_mt");
  #ifndef NO_AD_INITIALIZE
    L_fleet2_mt.initialize();
  #endif
  pred_fleet2_L_knum.allocate(styr,endyr,"pred_fleet2_L_knum");
  #ifndef NO_AD_INITIALIZE
    pred_fleet2_L_knum.initialize();
  #endif
  pred_fleet2_L_mt.allocate(styr,endyr,"pred_fleet2_L_mt");
  #ifndef NO_AD_INITIALIZE
    pred_fleet2_L_mt.initialize();
  #endif
  D_fleet3_num.allocate(styr,endyr,1,nages,"D_fleet3_num");
  #ifndef NO_AD_INITIALIZE
    D_fleet3_num.initialize();
  #endif
  D_fleet3_mt.allocate(styr,endyr,1,nages,"D_fleet3_mt");
  #ifndef NO_AD_INITIALIZE
    D_fleet3_mt.initialize();
  #endif
  pred_fleet3_D_knum.allocate(styr,endyr,"pred_fleet3_D_knum");
  #ifndef NO_AD_INITIALIZE
    pred_fleet3_D_knum.initialize();
  #endif
  pred_fleet3_D_mt.allocate(styr,endyr,"pred_fleet3_D_mt");
  #ifndef NO_AD_INITIALIZE
    pred_fleet3_D_mt.initialize();
  #endif
  ...
  #endif
  D_total_mt.allocate(styr,endyr,1,nages,"D_total_mt");
  #ifndef NO_AD_INITIALIZE
  ...
  #endif
  D_total_mt_yr.allocate(styr,endyr,"D_total_mt_yr");
  #ifndef NO_AD_INITIALIZE
  ...
  #endif
  F_fleet2_prop.allocate("F_fleet2_prop");
  #ifndef NO_AD_INITIALIZE
  F_fleet2_prop.initialize();
  #endif
  F_fleet3_prop.allocate("F_fleet3_prop");
  #ifndef NO_AD_INITIALIZE
  F_fleet3_prop.initialize();
  #endif
  ...
  F40_dum.initialize();
  #endif
  F50_dum.allocate("F50_dum");
  #ifndef NO_AD_INITIALIZE
  F50_dum.initialize();
  #endif
  Fproxy_dum.allocate("Fproxy_dum");
  #ifndef NO_AD_INITIALIZE
  Fproxy_dum.initialize();
  #endif
  ...
  F40_out.initialize();
  #endif
  F50_out.allocate("F50_out");
  #ifndef NO_AD_INITIALIZE
  F50_out.initialize();
  #endif
  Fproxy_out.allocate("Fproxy_out");
  #ifndef NO_AD_INITIALIZE
  Fproxy_out.initialize();
  #endif
  SSB_Fproxy_out.allocate("SSB_Fproxy_out");
  #ifndef NO_AD_INITIALIZE
  SSB_Fproxy_out.initialize();
  #endif
  B_Fproxy_out.allocate("B_Fproxy_out");
  #ifndef NO_AD_INITIALIZE
  B_Fproxy_out.initialize();
  #endif
  R_Fproxy_out.allocate("R_Fproxy_out");
  #ifndef NO_AD_INITIALIZE
  R_Fproxy_out.initialize();
  #endif
  L_Fproxy_knum_out.allocate("L_Fproxy_knum_out");
  #ifndef NO_AD_INITIALIZE
  L_Fproxy_knum_out.initialize();
  #endif
  L_Fproxy_mt_out.allocate("L_Fproxy_mt_out");
  #ifndef NO_AD_INITIALIZE
  L_Fproxy_mt_out.initialize();
  #endif
  D_Fproxy_knum_out.allocate("D_Fproxy_knum_out");
  #ifndef NO_AD_INITIALIZE
  D_Fproxy_knum_out.initialize();
  #endif
  D_Fproxy_mt_out.allocate("D_Fproxy_mt_out");
  #ifndef NO_AD_INITIALIZE
  D_Fproxy_mt_out.initialize();
  #endif
  wgt_wgted_L_mt.allocate(1,nages,"wgt_wgted_L_mt");
  #ifndef NO_AD_INITIALIZE
    wgt_wgted_L_mt.initialize();
  #endif
  wgt_wgted_D_mt.allocate(1,nages,"wgt_wgted_D_mt");
  #ifndef NO_AD_INITIALIZE
    wgt_wgted_D_mt.initialize();
  #endif
  ...
  #endif
  D_eq_mt.allocate(1,n_iter_msy,"D_eq_mt");
  #ifndef NO_AD_INITIALIZE
    D_eq_mt.initialize();
  #endif
  ...
  FdF_msy.allocate(styr,endyr,"FdF_msy");
    ...
    FdF_msy.initialize();
  #endif
  FdFproxy.allocate(styr,endyr,"FdFproxy");
  #ifndef NO_AD_INITIALIZE
    FdFproxy.initialize();
  #endif
  ...
  #endif
  SdSSB_Fproxy.allocate(styr,endyr,"SdSSB_Fproxy");
  #ifndef NO_AD_INITIALIZE
    SdSSB_Fproxy.initialize();
  #endif
  Sdmsst_Fproxy.allocate(styr,endyr,"Sdmsst_Fproxy");
  #ifndef NO_AD_INITIALIZE
    Sdmsst_Fproxy.initialize();
  #endif
  SdSSB_Fproxy_end.allocate("SdSSB_Fproxy_end");
  #ifndef NO_AD_INITIALIZE
  SdSSB_Fproxy_end.initialize();
  #endif
  Sdmsst_Fproxy_end.allocate("Sdmsst_Fproxy_end");
  #ifndef NO_AD_INITIALIZE
  Sdmsst_Fproxy_end.initialize();
  #endif
  FdFproxy_end_mean.allocate("FdFproxy_end_mean");
  #ifndef NO_AD_INITIALIZE
  FdFproxy_end_mean.initialize();
  #endif
  ...
  #endif
  L_age_Fproxy.allocate(1,nages,"L_age_Fproxy");
  #ifndef NO_AD_INITIALIZE
    L_age_Fproxy.initialize();
  #endif
  D_age_Fproxy.allocate(1,nages,"D_age_Fproxy");
  #ifndef NO_AD_INITIALIZE
    D_age_Fproxy.initialize();
  #endif
  ...
  #endif
  log_avg_F_fleet2.allocate(log_avg_F_fleet2_LO,log_avg_F_fleet2_HI,log_avg_F_fleet2_PH,"log_avg_F_fleet2");
  log_avg_F_fleet2_out.allocate(1,8,"log_avg_F_fleet2_out");
  #ifndef NO_AD_INITIALIZE
    log_avg_F_fleet2_out.initialize();
  #endif
  log_F_dev_fleet2.allocate(styr_fleet2_L,endyr_fleet2_L,log_F_dev_fleet2_LO,log_F_dev_fleet2_HI,log_F_dev_fleet2_PH,"log_F_dev_fleet2");
  log_F_dev_fleet2_out.allocate(styr_fleet2_L,endyr_fleet2_L,"log_F_dev_fleet2_out");
  #ifndef NO_AD_INITIALIZE
    log_F_dev_fleet2_out.initialize();
  #endif
  F_fleet2.allocate(styr,endyr,1,nages,"F_fleet2");
  #ifndef NO_AD_INITIALIZE
    F_fleet2.initialize();
  #endif
  F_fleet2_out.allocate(styr,endyr,"F_fleet2_out");
  #ifndef NO_AD_INITIALIZE
    F_fleet2_out.initialize();
  #endif
  log_F_dev_init_fleet2.allocate("log_F_dev_init_fleet2");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_init_fleet2.initialize();
  #endif
  log_F_dev_end_fleet2.allocate("log_F_dev_end_fleet2");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_end_fleet2.initialize();
  #endif
  log_avg_F_fleet3.allocate(log_avg_F_fleet3_LO,log_avg_F_fleet3_HI,log_avg_F_fleet3_PH,"log_avg_F_fleet3");
  log_avg_F_fleet3_out.allocate(1,8,"log_avg_F_fleet3_out");
  #ifndef NO_AD_INITIALIZE
    log_avg_F_fleet3_out.initialize();
  #endif
  log_F_dev_fleet3.allocate(styr_fleet3_D,endyr_fleet3_D,log_F_dev_fleet3_LO,log_F_dev_fleet3_HI,log_F_dev_fleet3_PH,"log_F_dev_fleet3");
  log_F_dev_fleet3_out.allocate(styr_fleet3_D,endyr_fleet3_D,"log_F_dev_fleet3_out");
  #ifndef NO_AD_INITIALIZE
    log_F_dev_fleet3_out.initialize();
  #endif
  F_fleet3.allocate(styr,endyr,1,nages,"F_fleet3");
  #ifndef NO_AD_INITIALIZE
    F_fleet3.initialize();
  #endif
  F_fleet3_out.allocate(styr,endyr,"F_fleet3_out");
  #ifndef NO_AD_INITIALIZE
    F_fleet3_out.initialize();
  #endif
  log_F_dev_init_fleet3.allocate("log_F_dev_init_fleet3");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_init_fleet3.initialize();
  #endif
  log_F_dev_end_fleet3.allocate("log_F_dev_end_fleet3");
  #ifndef NO_AD_INITIALIZE
  log_F_dev_end_fleet3.initialize();
  #endif
  ...
  #endif
  D_age_spr.allocate(1,nages,"D_age_spr");
  #ifndef NO_AD_INITIALIZE
    D_age_spr.initialize();
  #endif
  ...
  F_spr.allocate(1,n_iter_spr,"F_spr");
    ...
    F_spr.initialize();
  #endif
  D_spr.allocate(1,n_iter_spr,"D_spr");
  #ifndef NO_AD_INITIALIZE
    D_spr.initialize();
  #endif
  ...
  #endif
  sdnr_ac_fleet2.allocate("sdnr_ac_fleet2");
  #ifndef NO_AD_INITIALIZE
  sdnr_ac_fleet2.initialize();
  #endif
  phsp.allocate("phsp");
  #ifndef NO_AD_INITIALIZE
  phsp.initialize();
  ...
  PPOP.initialize();
  #endif
  PHSP_vec.allocate(f_ckmr,e_ckmr,"PHSP_vec");
  #ifndef NO_AD_INITIALIZE
    PHSP_vec.initialize();
  #endif
  PPOP_vec.allocate(f_ckmr,e_ckmr,"PPOP_vec");
  #ifndef NO_AD_INITIALIZE
    PPOP_vec.initialize();
  #endif
  nll_ckmr.allocate("nll_ckmr");
  #ifndef NO_AD_INITIALIZE
  nll_ckmr.initialize();
  #endif
  w_L.allocate("w_L");
  ...
  #endif
  w_ac_fleet2.allocate("w_ac_fleet2");
  #ifndef NO_AD_INITIALIZE
  w_ac_fleet2.initialize();
  #endif
  w_lc_fleet3.allocate("w_lc_fleet3");
  #ifndef NO_AD_INITIALIZE
  w_lc_fleet3.initialize();
  #endif
  ...
  #endif
  f_fleet2_L.allocate("f_fleet2_L");
  #ifndef NO_AD_INITIALIZE
  f_fleet2_L.initialize();
  #endif
  f_fleet3_D.allocate("f_fleet3_D");
  #ifndef NO_AD_INITIALIZE
  f_fleet3_D.initialize();
  #endif
  ...
  #endif
  f_fleet2_agec.allocate("f_fleet2_agec");
  #ifndef NO_AD_INITIALIZE
  f_fleet2_agec.initialize();
  #endif
  f_fleet3_lenc.allocate("f_fleet3_lenc");
  #ifndef NO_AD_INITIALIZE
  f_fleet3_lenc.initialize();
  #endif
  ...
  #endif
  D_mt_proj.allocate(styr_proj,endyr_proj,"D_mt_proj");
  #ifndef NO_AD_INITIALIZE
    D_mt_proj.initialize();
  #endif
...
{
  dvector temp1("{1000, 2000,5000, 15000;}");
...
void model_parameters::userfunction(void)
{
 ...
 get_hsp_prob();
 //cout << "got half-sibling pairs" << endl;
 get_pop_prob();
 //cout << "got parent-offspring pairs" << endl;
...
void model_parameters::get_natural_mortality(void)
{
  //scalar on natural mortality vector may be estimated
  M_scale = (2.0*exp(M_logit))/(1.0+exp(M_logit));
  //Lorezen M fcn (2022); b par (M_b) can be estimated
  M_lorenzen = exp(0.0 + M_b * log(M_len));
  M_unscaled = M_lor_scale * M_lorenzen / max(M_lorenzen);
  M = M_scale * M_unscaled;
}
...
void model_parameters::get_reprod(void)
{
   ...
   ckmr_fec=elem_prod(elem_prod(maturity_f,fecundity),fecpar_batches); //added for ckmr calcs in get_hsp/pop funcs
}

void model_parameters::get_len_at_age_dist(void)
{
...
void model_parameters::get_hsp_prob(void)
{
  for(int i=f_ckmr;i<e_ckmr;i++)
  {   // cycle through years of sampling
    phsp = 0.0; 
    int d = c2(i) - c1(i); // measure the time between birth of fish in cohort 1 and cohort 2
    for(int as=d+1;as<=nages;as++)
    { // cycle through ages
      dvariable tmp_hsp = 1.0; // to accumulate the product of the HSP probability
      tmp_hsp *= N_spawn(c1(i),as-d)*ckmr_fec(as-d)/ SSB(c1(i)); // relative reproductive output of fish in year c1 was born
      for(int s=1;s<=d;s++) 
      {
        tmp_hsp *= mfexp(-Z(c1(i)+s, as-d+s)); // multiply by survival 
      } 
      phsp+= tmp_hsp * ckmr_fec(as)/ SSB(c2(i)); // multiply surviving reproductive output from c1 to c2 by relative reproductive output of fish in year c2 was born
      //phsp+=tmp_hsp; // sum 
    } 
    PHSP = 2 * phsp;  
    PHSP_vec(i) = PHSP; // to report out
  } 
}

void model_parameters::get_pop_prob(void)
{
  for(int i=f_ckmr;i<e_ckmr;i++)
  {
    ppop = 0.0;
    int d = s1(i) - c2(i); // gap between sample year of parent and birth of offspring
    for(int as=d+1;as<=nages;as++)
    {
      dvariable tmp_pop = 1.0;
      ppop += tmp_pop * ckmr_fec(as-d) / SSB(c2(i)); // relative reproductive output the year when offspring was born
      //ppop+=tmp_pop; //sum
    } 
    PPOP = ppop; 
    PPOP_vec(i) = PPOP; // to report out; note we assume probability is time-invariant
  }
}
  ...
  if (!report)
  {
    ...
    if (last_phase())  
    {
      ...
      //################################################################################################# 
       ...
       M_b_out(8)=M_b; M_b_out(1,7)=set_M_b;
